...
var releaseFolder = "./VaraniumSharp.Initiator/bin/Release";
var releaseDll = "/VaraniumSharp.Initiator.dll";
var unitTestPaths = "./VaraniumSharp.Initiator.Tests/bin/Release/VaraniumSharp.Initiator.Tests.dll";
...
var sonarQubeProject = "VaraniumSharp.Initiator";
var sonarQubeKey = "";
	...
	.Does(() =>
	{
		...
		DotCoverAnalyse(tool => {
			...
			new DotCoverAnalyseSettings()
			{
				...
				.WithFilter("+:VaraniumSharp.Initiator")
